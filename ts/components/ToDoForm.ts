...
export class ToDoForm {
    ...
    constructor() {
       ...
       this.naziv.setAttribute("placeholder", "Task name")
       ...
       this.label.innerHTML = "Check if you have any deadline"
       this.vreme = <HTMLInputElement>document.createElement("input")
       this.vreme.setAttribute("type", "text")
       this.vreme.setAttribute("placeholder", "MM/DD/YYYY/HH:MM")
       ...
       this.btn.addEventListener("click", () => {
        ...
        let val2 = this.vreme.value
            ...
            if(val1.trim() === "") {
                this.pNaziv.innerHTML = "The field can't be empty, please enter the task name!"   
                throw new Error()
            } 
        ...
        if(this.checkB.checked === true) {
            ...
            if(val2.trim().length !== 16) {
                this.pVreme.innerHTML = "The field must have 16 characters in following form: MM/DD/YYYY/HH:MM"
                throw new Error()
            }
